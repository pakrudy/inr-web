                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('records.index') }}" class="hover:text-gray-900 ml-1 md:ml-2">Legacy Index</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 md:ml-2 text-gray-700 font-medium truncate max-w-xs">{{ $record->title }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                <div class="grid grid-cols-1 lg:grid-cols-5">
                    ...
                    <div class="lg:col-span-2 bg-gray-100 p-8 flex items-center justify-center relative group">
                         @if ($record->photo)
                            <a href="{{ asset('storage/' . $record->photo) }}" data-fslightbox>
                                <img src="{{ asset('storage/' . $record->photo) }}" alt="{{ $record->title }}" class="max-h-[500px] w-auto shadow-lg rounded-lg transform group-hover:scale-105 transition duration-500">
                            </a>
                    ...
                    <div class="lg:col-span-3 p-8 lg:p-12 flex flex-col justify-center">
                        ...
                        <div class="border-t border-gray-100 pt-8 mt-4">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4">Pemegang Legacy</h3>
                            <div class="flex items-start space-x-4">
                                <!-- Customer Photo -->
                                <div class="flex-shrink-0">
                                    @if ($record->user->foto_pelanggan)
                                        <img src="{{ asset('storage/' . $record->user->foto_pelanggan) }}" alt="Foto {{ $record->user->name }}" class="w-20 h-20 rounded-full object-cover shadow-md">
                                    @else
