...
<header id="about" class="relative py-24 bg-gray-800 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1920&auto=format&fit=crop');">
    ...
    <div class="container mx-auto px-4 text-center relative z-10">
        ...
        <div class="mt-10">
            <a href="/records" class="bg-yellow-500 hover:bg-yellow-400 text-gray-900 font-bold py-3 px-8 rounded-2xl transition duration-300 transform hover:scale-105 inline-block">
                Legacy Index
            </a> 
            <a href="/recommendations" class="bg-orange-400 hover:bg-orange-300 text-gray-900 font-bold py-3 px-8 rounded-2xl transition duration-300 transform hover:scale-105 inline-block">
                            ...
                            <div class="p-5 flex flex-col justify-center w-2/3">
                                ...
                                <h3 class="text-lg font-bold text-gray-900" title="{{ $legacy->title }}">
                                    <a href="{{ route('records.show', $legacy->id) }}" class="hover:text-orange-700 transition-colors">
                                        {{ $legacy->title }}
                                    </a> <span class="text-sm font-medium text-orange-600 ml-2 mt-1"><i class="fas fa-tag mr-1"></i>{{ $legacy->category?->name ?? '-' }}</span>
                                </h3>
...
<section id="testimonials" class="py-20 bg-gray-900 text-white">
    ...
    <section class="py-6 bg-gray-50 border-y border-gray-100 mb-12">
