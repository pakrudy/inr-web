                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Ajukan Rekomendasi?</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($achievements as $achievement)
                                    <tr>
                                        <td class="px-6 py-4 max-w-xs truncate text-sm">{{ $achievement->judul_prestasi }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $achievement->user->name }}</td>
